...
constructor(url: URL , outFile: File) {
        ...
        try {
            ...
            if (status == HttpURLConnection.HTTP_OK) {
                ...
                inputStream.use { input ->
                    loutFile.outputStream().use { output ->
                        input.copyTo(output)
                    }
                }
                ...
                onFileUploadedListener?.onFileUploadingSuccess(loutFile)
            } else {
    ...
    interface OnFileUploadedListener {
        fun onFileUploadingSuccess(response: File)
